...
/**
 * JSON converter that doesn't shit itself when given null data to convert. Intended specifically to
 * reduce noise in integration tests when used for offset storage.
 */
